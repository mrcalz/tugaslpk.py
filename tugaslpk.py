...
if (selected == 'Informasi Singkat') :
    ...
    st.write('Penggunaan aplikasi dalam pendidikan semakin berkembang dengan adanya aplikasi yang disediakan untuk membantu proses pengajaran dan pembelajaran. Perhitungan Luas dan Volume Bangun masih diolah secara manual dengan rumus dan dicari menggunakan kalkulator sehingga membutuhkan waktu yang lumayan lama dalam perhitungannya, maka dari itu dibutuhkan sebuah aplikasi yang dapat menghitung nilai luas dan volume bangun. Pembuatan aplikasi luas dan volume bangun adalah salah satu solusi untuk mengatasi lambatnya perhitungan dan ketelitian dalam menghitung. Aplikasi pengolahan nilai ini dibuat menggunakan anaconda. Hasil akhir dari nilai tersebut diproses menjadi nilai luas bangun datar. Dari hasil penelitian yang dilakukan diperoleh kesimpulan bahwa aplikasi perhitungan luas dan volume bangun merupakan solusi untuk membantu proses perhitungan bagi siswa- siswi sekolah dasar.Bangun datar merupakan sebuah bangun geometri dua yang memiliki permukaan datar serta memiliki dua dimensi, yakni panjang dan lebar. Permukaan bagun datar biasanya dibatasi oleh garis lurus ataupun lengkung. Bangun datar mempunyai berbagai bentuk, seperti segitiga, persegi, persegi panjang, lingkaran, trapesium, dan jajargenjang. Bangun ruang adalah sebuah bangun geometri yang berisikan volume dan isi, selain itu juga bangun ruang juga memiliki tiga komponen penyusun lain berupa dimensi tiga yang mempunyai sifat-sifat tertentu, yakni dengan adanya sisi (bidang), rusuk, dan titik sudut. Adapun macam-macam bangun ruang, yaitu kubus, balok, prisma, limas, tabung, kerucut, dan bola.')
